...
These variables are taken from Samsung Data set, describing various aggregated smartphone sensor data for each observation.
...
For each of the variables, mean and std values are available.
